...
/** Shared CDN cache. Browsers still revalidate (`max-age=0`); the edge absorbs duplicate visitors. */
function sendCached(res: express.Response, seconds: number, body: unknown) {
