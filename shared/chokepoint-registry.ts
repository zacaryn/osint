    ...
    restrictions: [
      {
        ...
        since: "2026-03-01",
        note: "Not a declared closure. A residual few vessels a day still pass, reportedly under Iranian clearance and transit tolls, and Iran has struck at least one tanker inside the strait. Gulf crude has no comparable alternative sea route, so read this against the Cape of Good Hope trend rather than against Suez.",
        kind: "de-facto",
        confidence: "reported",
      },
      {
        ...
        since: "2023-04-27",
        note: "Predates and is now subsumed by the general closure. Ownership or charterer linkage, not flag, is what draws a boarding, and Iran asserts judicial or environmental grounds case by case rather than declaring a closure.",
        kind: "de-facto",
  ...
  },
  {
    ...
    restrictions: [
      ...
      },
      {
        ...
        since: "2023-11-19",
        note: "Vessels sunk include Rubymar (Mar 2024), Tutor (Jun 2024), Magic Seas and Eternity C (Jul 2025). Tempo has varied sharply with the Gaza ceasefire cycle — read the live headlines before assuming the current state.",
        kind: "de-facto",
        confidence: "reported",
      },
      {
        ...
        since: "2024-01-12",
        note: "Targeting keys on ownership, operator and port history rather than flag, and has repeatedly caught vessels with no actual connection.",
        kind: "de-facto",
        confidence: "reported",
      },
    ],
